...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          Text(widget.headline, style: const TextStyle(fontSize: 48, color: Colors.white)),
          TrackingElement(color: const Color(0xFF88EF11),
              iconData: Icons.directions_run,
              unit: 'm',
              max: 5000,
              daysInPast: widget.daysInPast),
          TrackingElement(color: const Color(0xFF3853EA),
              iconData: Icons.local_drink,
              unit: 'ml',
              max: 3000,
              daysInPast: widget.daysInPast),
          TrackingElement(color: const Color(0xFFC42541),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Column(
        children: <Widget>[
          Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(32, 64, 32, 16),
            child: Row(
              children: <Widget> [
                Icon(
                  widget.iconData,
